...
//                    .scaledToFit()
//                    .opacity(1)
                DrawView(mainColorWithoutOpacity: self.mainColor,shadowOpacity: self.shadowOpacity, eyeColor: self.eyeColor, imgName: self.imgName, device: self.device,imgOpacity: imgOpacity)
            }
        }.frame(minWidth: 0,
                maxWidth: .infinity,
                minHeight: 0,
